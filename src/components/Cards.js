        ...
        <div className="cards__container">
            <div className="cards__wrapper">
                <ul className="cards__items">
                    ...
                    />
                    <CardItem 
                    src="images/img-2.jpg" text='Travel through the Island of Bali in a Private Cruise' label='Luxury' path='/services'
                    />
                </ul>
                <ul className="cards__items">
                    <CardItem 
                    src="images/img-3.jpg" text='Set sail in the Atlantic Ocean visiting Uncharted Water' label='Mystry' path='/services'
                    />
                    <CardItem 
